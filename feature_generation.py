...
def main():
    ...
    process_and_save(sampled_test_data, "data/isd_sampled_test.csv")
    process_and_save(full_test_debates, "data/isd_full_test.csv")
    process_and_save(sampled_train_data, "data/isd_sampled_train.csv")
    process_and_save(full_train_debates, "data/isd_full_train.csv")
